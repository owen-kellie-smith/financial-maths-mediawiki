...
CT1_autoloader(		"FinMathForm", "includes/class-ct1-form.php");
CT1_autoloader(		"CT1_XML", "includes/class-ct1-xml.php");
CT1_autoloader(		"FinMathFormXML", "includes/class-ct1-form-xml.php");
CT1_autoloader(		"FinMathInterestFormat", "includes/class-ct1-interest-format.php");
CT1_autoloader(		"FinMathInterest",	"includes/class-ct1-interest.php");
...
CT1_autoloader(		"FinMathCollection", "includes/class-ct1-collection.php");
...
CT1_autoloader(		"FinMathForwardRate", "includes/class-ct1-forward-rate.php");
...
CT1_autoloader(		"FinMathMortgage", "includes/class-ct1-mortgage.php");
